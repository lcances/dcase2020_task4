"""
	CODE IMPORTED FROM https://github.com/szagoruyko/wide-residual-networks/blob/master/pytorch/resnet.py
	Has been modified : Yes
"""

import torch.nn.functional as F
import dcase2020_task4.other_models.wrn_utils as utils
...
def resnet(depth, width, num_classes):
    ...
    def f(input, params, mode):
        ...
        g0 = group(x, params, 'group0', mode, 1, n)
        g1 = group(g0, params, 'group1', mode, 2, n)
        g2 = group(g1, params, 'group2', mode, 2, n)
