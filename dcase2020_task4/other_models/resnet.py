...
class ResNetRot(ResNet):
	def __init__(self, block, num_blocks, num_classes=10, rot_output_size: int = 4):
		super().__init__(block, num_blocks, num_classes)
		self.classifier_rot = nn.Linear(512 * block.expansion, rot_output_size)
...
def ResNet18Rot():
	return ResNetRot(BasicBlock, [2, 2, 2, 2])
