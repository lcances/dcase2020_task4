...
srun singularity exec $path_torch $path_py $path_script --dataset $path_dataset --dataset_name $dataset_name --nb_classes $nb_classes --logdir $path_board --debug False --model_name "VGG11" --batch_size_s 64 --batch_size_u 64 --num_workers_s 4 --num_workers_u 4 --nb_epochs 100 --lambda_u 1.0 --write_results True --use_rampup True --cross_validation False --run "$run" --suffix "$suffix"
